...
`SosAudioReceiver` (Kotlin) i `ParentSosReceiver` (web) nie uruchamiają MediaRecorder, dopóki nie ma zdalnej ścieżki audio.
...
MainActivity jeszcze tego odbiornika nie wywołuje. Karta na mapie czeka i nie nagrywa.
