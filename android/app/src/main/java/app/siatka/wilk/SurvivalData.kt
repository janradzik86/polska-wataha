...
object SurvivalData {
    ...
    val KB: List<AskEntry> = listOf(
        ...
        AskEntry("Mapa", listOf("mapa", "mapę", "gdzie jest", "punkt pomocy", "węzły", "trasa"),
            "Co pokazuje mapa?",
            "🗺️ Otwórz Mapę Watahy. Jeśli masz wcześniej pobrany pakiet mapy offline, korzystaj z niego bez internetu. Punkty pomocy i dane lokalne pokazuj tylko wtedy, gdy aplikacja ma je zapisane lub zweryfikowane."),
        ...
        AskEntry("Aplikacja", listOf("aplikacja", "wersja", "aktualizacja", "działa", "instalacja"),
            "Co to za aplikacja?",
            "🐺 Polska Wataha to lokalna platforma wymiany, pomocy i komunikacji kryzysowej. WILK działa lokalnie bez internetu. Pozostałe funkcje offline zależą od tego, jakie dane i moduły są faktycznie dostępne w zainstalowanej wersji aplikacji."),
        AskEntry("Gdzie jestem", listOf("gdzie jestem", "lokalizacja", "gps", "współrzędne", "pozycja"),
            "Jak sprawdzić swoją lokalizację?",
            "📍 Otwórz Mapę → Moja pozycja i przyznaj uprawnienie lokalizacji. Jeśli telefon uzyska pozycję GPS, aplikacja pokaże współrzędne. Bez zgody lub bez ustalonej pozycji WILK nie powinien zgadywać lokalizacji."),
